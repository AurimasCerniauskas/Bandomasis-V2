...
import Box from './Components/boxes/Main';
...
function App() {
    ...
    return (
      ...
      <Routes>
        ...
        <Route path="/containers" element={<RequireAuth role='admin'><Container /></RequireAuth>}></Route>
        <Route path="/boxes" element={<RequireAuth role="admin"><Box /></RequireAuth>}></Route>
